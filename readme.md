...
FL Studio displays all stock plugins in the plugin browser and does not allow hiding them through the Plugin Manager. Unlike third-party VSTs, stock plugins ignore the visibility toggle — they always show up, including demo-only plugins that are not part of your edition.
